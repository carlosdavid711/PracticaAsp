...
namespace Terceintento.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Carnet,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,FechaNacimiento,Edad")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Carnet,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,FechaNacimiento,Edad")] Estudiantes estudiantes)
        {
            if (ModelState.IsValid)
            {
